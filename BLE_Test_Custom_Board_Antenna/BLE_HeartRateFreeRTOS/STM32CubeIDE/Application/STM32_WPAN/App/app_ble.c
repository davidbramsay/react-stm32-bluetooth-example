...
osMutexId_t MtxHciId; //in app_ble.c globals
...
osThreadId_t AsynchBleId;
const osThreadAttr_t AsynchBle_attr = {
  .name = "ASYNCH_BLE_PROCESS",
	.attr_bits = (0),
	.cb_mem = (0),
	.cb_size = (0),
	.stack_mem = (0),
...
osThreadId_t AdvCancelId;
const osThreadAttr_t AdvCancel_attr = {
  .name = "ADVCANCEL_PROCESS",
	.attr_bits = (0),
	.cb_mem = (0),
	.cb_size = (0),
	.stack_mem = (0),
